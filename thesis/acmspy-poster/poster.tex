...
\begin{columns}[t, totalwidth=\textwidth]
  ...
  \end{columns}
    ...
    \begin{block}{Challenges and Solutions}
      ...
      \begin{column}{0.48\textwidth}
      \begin{enumerate}
      \item[4.] Design a computer language for game specification
        \thando{
      ...
      \item[5.] Implement proposed algorithms in a computer program
        \thando{
      ...
      \item[6.] Use the tool to create new and reproduce existing results
        \thando{
