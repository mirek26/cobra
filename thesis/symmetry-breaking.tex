...
\TODO{If $v$ satisfies $\stgknow{\stg}{\val}{k}$, it satisfies $\stgknow{\stg}{\val}{l}$ for all $l < k$.}
...
For $k=0$ it clearly holds, as any \TODO{$\perm\in\symg \init = \init^\perm$. Potřebuju to nebo ne?}
