...
Much later, Kooi\cite{mm-mostparts} came up with a simple strategy that
  maximizes the number of possible responses by the codemaker (parts),
...
\footnotetext{Irwing's paper reports 4.395 as the expected number
 ...
 The number reported by our tool when using this strategy only is 4.626.}
\stepcounter{footnote}
\footnotetext{We were not able to reproduce the result 4.416 of Neuwirth,
 as he does not always follow the choice of the strategy as described.
